...
第一版本核心闭环及 Stage 10—12 通过自动化及发布包验收。Ollama AI、可替换 Provider 接口、容器部署配置和移动端离线工程已具备；实际 Docker 镜像构建需先启动 Docker 服务，实际 APK 构建需安装 Android SDK。
